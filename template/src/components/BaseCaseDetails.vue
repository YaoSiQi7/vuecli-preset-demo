<template>
  <v-row v-if="hitRule && Object.keys(hitRule).length > 0">
    <v-col cols="6">
      <div style="border: 1px solid #F3F3F3;">
        <v-card-title class="header_bg_color">
          上线风险策略
        </v-card-title>
        <v-row class="mt-2" style="padding: 0;margin:0;min-height: 90px;">
          <v-col
            cols="3"
    ...
    <v-col cols="6">
      <div style="border: 1px solid #F3F3F3;">
        ...
        <v-row class="mt-2" style="padding: 0;margin:0;min-height: 90px;">
          <v-col cols="3" style="padding: 0;margin:0;text-align: center;">
            <!-- 人工审核 -->
