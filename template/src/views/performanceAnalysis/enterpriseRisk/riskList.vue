...
<script>
import { queryList, querysList, exportTemplate, exportQueryList, exportList } from 'api/enterpriseRisk.js';
...
export default {
  ...
  data () {
    return {
      ...
      searchParam: [
        ...
        { type: 'text', placeholder: '公司名称', value: '' },
        {
          type: 'datesrange',
          placeholder: '最早开户日期',
          value: []
      ...
      listDataHeaders: [
        ...
        { text: '公司名称', value: 'enterpriseName', sortable: false, width: 180 },
        { text: '法人', value: 'legalPerson', sortable: false, width: 100 },
        {
          text: '统一社会信用代码',
          value: 'creditCode',
          sortable: false,
  ...
  beforeRouteLeave (to, from, next) {
    ...
    // });
    if (to.name === 'enterpriseRiskDetail') {
  ...
  methods: {
    ...
    searchQuery () {
      ...
      enterpriseName = this.searchParam[3].value;
    ...
    editNameListSet (item) {
      ...
      window.sessionStorage.setItem('tabsName', '企业风险监控');
    },
    // 批量查询
    batchQuery () {
