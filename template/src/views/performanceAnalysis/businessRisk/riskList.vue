...
<script>
import { queryList, querysList, exportTemplate, exportQueryList, exportList } from 'api/businessRisk.js';
...
export default {
  ...
  data () {
    return {
      ...
      searchParam: [
        ...
        { type: 'text', placeholder: '法人', value: '' },
        { type: 'text', placeholder: '商户号', value: '' },
        { type: 'text', placeholder: '商户名称', value: '' },
        {
          type: 'datesrange',
          placeholder: '最早开户日期',
          value: []
        ...
        { type: 'text', placeholder: '统一社会信用代码', value: '' }
      ],
      dates: [],
      datey: [],
      searchData: {
      ...
      // table列表表头
      listDataHeaders: [
        { text: '商户号', value: 'merchantNo', sortable: false, width: 100 },
        { text: '商户名称', value: 'merchantName', sortable: false, width: 180 },
        { text: '法人', value: 'legalPerson', sortable: false, width: 80 },
        {
          text: '统一社会信用代码',
          value: 'creditCode',
          sortable: false,
        ...
        { text: '最早开户日期', value: 'earliestOpenTime', sortable: false, width: 110 },
        { text: '业务归属机构', value: 'organ', sortable: false, width: 120 },
  ...
  methods: {
    ...
    searchQuery () {
      ...
      let organ = '';
      let riskLevel = '';
      legalPerson = this.searchParam[1].value;
      merchantNo = this.searchParam[2].value;
      merchantName = this.searchParam[3].value;
      ...
      this.searchData = {
        ...
        organ: organ,
        riskLevel: riskLevel,
        creditCode: this.searchParam[7].value
      };
      this.getNameListSetList();
    ...
    editNameListSet (item) {
      ...
      window.sessionStorage.setItem('tabsName', '商户风险监控');
    },
    // 批量查询
    batchQuery () {
